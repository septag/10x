...
With this script, you can add the ability to scroll faster with keyboard shortcuts. More like mousewheel scrolling.

## Usage
Copy the script into `%AppData%\Roaming\10x\PythonScripts`. Open "Key bindings" and assign any shortcuts to `FastScrollUp` and `FastScrollDown` commands.
